...
{
    showMessage("FlipComic");
    openFlipComicActivity("droidscript/comics/Flextid", 2);
}

function openDemoPanoFrame()
{
    openPanoStripActivity("droidscript/comics/PanoFrameDemo", 5102, 476, 200)
}

function openDemoPanoStrip()
{
    openPanoStripActivity("droidscript/comics/PanoStripDemo", 5612, 480, 200);
}

function openComiKitWebSite()
{
    showMessage("ComiKitWebSite");
}

function openFlipComicActivity(panelBasePath, numberOfPanels)
{
    var DroidScriptActivity = Packages.comikit.droidscript.DroidScriptActivity;
    var DroidScriptFileHandler = Packages.comikit.droidscript.DroidScriptFileHandler;
    var Intent = Packages.android.content.Intent;
    var scriptFileName = "droidscript/FlipComicActivity.js";
    ...
    intent.putExtra("PanelBasePath", panelBasePath);
    intent.putExtra("NumberOfPanels", "" + numberOfPanels);
    Activity.startActivity(intent);
}

function openPanoStripActivity(stripBasePath, stripWidth, stripHeight, sliceWidth)
{
    var DroidScriptActivity = Packages.comikit.droidscript.DroidScriptActivity;
    var DroidScriptFileHandler = Packages.comikit.droidscript.DroidScriptFileHandler;
    var Intent = Packages.android.content.Intent;
    var scriptFileName = "droidscript/PanoStripActivity.js";
    var script = DroidScriptFileHandler.create().readStringFromFileOrUrl(scriptFileName);
    var intent = new Intent();
    intent.setClassName(Activity, "comikit.droidscript.DroidScriptActivity");
    intent.putExtra("Script", script);
    intent.putExtra("StripBasePath", stripBasePath);
    intent.putExtra("StripWidth", "" + stripWidth);
    intent.putExtra("StripHeight", "" + stripHeight);
    intent.putExtra("SliceWidth", "" + sliceWidth);
    Activity.startActivity(intent);
}
